...
from GAF.common.thumos_dataset import get_video_info, get_class_index_map
...
if __name__ == '__main__':
    ...
    for video_name in tqdm.tqdm(list(video_infos.keys()), ncols=0):
        ...
        for offset in offsetlist:
            ...
            with torch.no_grad():
                video_feature = net(clip, mode = 'bone')
                ...
                feature_4f = (feature_4f * attention_4f) / (attention_4f.sum())
           

                feat_dict['Mixed_5c'] = feature_5c
                feat_dict['Mixed_4f'] = feature_4f
